...
int DEPTH = 6; // Recursive depth
float MIN_ANGLE = 15.0; //Minimum angle for new branch
float MAX_ANGLE = 20.0; //Maximum angle for new branch
float MIN_LENGTH = 0.30; //Minimum length of new branch, as a pct of current length
float MAX_LENGTH = 0.80; //Maximum length of new branch, as a pct of current length
